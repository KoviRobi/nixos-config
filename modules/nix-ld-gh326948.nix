...
let
  ...
  cfg = config.programs.nix-ld-gh326948.systems;
...
in
{
  ...
  imports =
    let
      ...
      system = pkgs.stdenv.hostPackages.system or ''''${pkgs.system}'';
    in
    [
      (mkAliasOptionModule
        [ "programs" "nix-ld-gh326948" "enable" ]
        [ "programs" "nix-ld-gh326948" "systems" system "enable" ]
      )
      (mkAliasOptionModule
        [ "programs" "nix-ld-gh326948" "package" ]
        [ "programs" "nix-ld-gh326948" "systems" system "package" ]
      )
      (mkAliasOptionModule
        [ "programs" "nix-ld-gh326948" "libraries" ]
        [ "programs" "nix-ld-gh326948" "systems" system "libraries" ]
      )
    ];

  options.programs.nix-ld-gh326948.systems = mkOption {
    default = { };
    description = ''
